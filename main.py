...
connection.execute("INSERT INTO albums VALUES ( 6,'Black Star',2006);")
connection.execute("INSERT INTO albums VALUES ( 7,'Холостяк',2018);")
...
#  Заполнение таблицы состав сборника
